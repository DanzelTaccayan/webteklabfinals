...
if(isset($_SESSION['username']) && $_SESSION['UserType'] =='admin') {
	...
	//header redd
    header("Location: http://192.168.0.111:5000/auth?username=" . $_SESSION['idUser']);
    session_unset();
    session_destroy();
}else if(isset($_SESSION['username']) && $_SESSION['UserType'] =='customer') {
	//header gelo
    header("Location: http://192.168.0.103:8080/ClientModuleFinal/Validate?user=".$_SESSION['id']);
    session_destroy();
    session_unset();
}
?>

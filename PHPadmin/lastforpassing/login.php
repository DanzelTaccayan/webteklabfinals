 ...
 session_start();
    ...
    if(!empty($_POST['username']) && !empty($_POST['password'])){
        if(isset($_POST['submit'])){
                ...
                $use = "SELECT idUser, username,password,status,UserType FROM users inner join user_details on users.idUsers = user_details.idUser where username = '$username' and status = 'Active'";

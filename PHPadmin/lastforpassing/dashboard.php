...
<div class="nav notify-row" id="top_menu">
       ...
       <li> <button type="button" id='dashnotif' class="btn btn-info" data-toggle="modal" name='notif' data-target="#myModal" style='float:right;'><i class="fa fa-tasks"></i><span class="badge bg-theme">
       <?php
...
<script>
  ...
  document.getElementById('dashnotif').onclick = function(){
...
xmlhttp.open("GET","admin/update_notifications.php",true);
xmlhttp.send();
}
